...
Solutions to Études
-------------------
Here are suggested solutions to the études.
I wrote them as I was learning Erlang, so you may find that some
of the solutions are naïve in the extreme. 
...
[source, erlang]
----
include::code/ch04-03/roots.erl[]
----
...
<<CH06-ETinterlude,the interlude in Chapter 6>>.
