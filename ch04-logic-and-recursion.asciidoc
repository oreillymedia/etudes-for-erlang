[[LOGIC-RECURSION]]
Études for Chapter 4: Logic and Recursion
-----------------------------------------
...
Note that this function is _not_ tail recursive. Here is what its output
looks like:
...
Étude 4-5
~~~~~~~~~
In this exercise, you will write a function +nth_root/2+ which finds the
...
* If the absolute value of +Next - A+ is
...
calculate it. Here's what the program will look like when you run it.
