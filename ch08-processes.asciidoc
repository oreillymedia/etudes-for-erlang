...
****************
Simon, I have two options here: I can give details about the
design, or a broad outline. Here's the detail version
*****************
...
****************
And now, the broad outline version
****************
When you do your design, think about what the players have to keep
track of and what the dealer has to keep track of (it's a lot more).

You might want to think about the game as a state machine; the
game is in one of several phases (or states) at any point, and proceeds
to a different state depending upon the cards given or received.
