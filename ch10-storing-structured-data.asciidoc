...
Étude 10-2
~~~~~~~~~~
In this étude, you will create a Mnesia database that contains veterinarian
appointments for cats. You will need two types of records.
...
Put the following initial data in a file named +cats.csv+.
...
And here is the initial data, in a file named +appointments.csv+
